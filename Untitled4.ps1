try{
    ...
    $postParams = @{client_id='6ce7fc35-55d3-4779-b422-04580130b55d';scope='https://graph.microsoft.com/.default';client_secret='RPN8Q~BpxW_NmJvE7SwyE17K1a7UBqUe1.8CoasI';grant_type='client_credentials'}
